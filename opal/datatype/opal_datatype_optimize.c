...
int32_t opal_datatype_commit(opal_datatype_t *pData)
{
    ...
    if (0 == (pData->flags & OPAL_DATATYPE_FLAG_PREDEFINED))
    {
        ...
        pData->ddtpack_hndl.flags = OPAL_DATATYPE_FLAG_OPTIMIZED_PACKING;
        // Generate packing + unpacking code for this datatype
        ddtpack_commit((ddtpack_datatype_s*)pData);
    }
    else
    {
        pData->ddtpack_hndl.flags = 0;
    }
